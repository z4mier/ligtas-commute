    ...
    <SafeAreaView style={s.screen}>
      ...
      <Modal visible={profileModal} transparent animationType="fade">
        <View style={s.modalOverlay}>
          <View style={s.modalBox}>
            ...
            <TouchableOpacity onPress={() => { setProfileModal(false); setSecurityModal(true); }} style={[s.btn, s.btnGhost, { marginTop: 8 }]}>
              <Text style={[s.f600, { color: theme.text }]}>{t("managePw", "Change Password")}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
            ...
            <View style={s.infoBoxBody}>
              ...
              <EditRow theme={theme} s={s} icon="phone-outline">
                <TextInput
                  ...
                  placeholder={t("placeholder.phone", "Phone")}
                  placeholderTextColor={theme.textSub}
                />
              </EditRow>
              ...
              <EditRow theme={theme} s={s} icon="calendar-month-outline">
                <Text style={[s.small, { color: theme.textSub }]}>{joinText}</Text>
              </EditRow>
            </View>
      ...
      <Modal visible={securityModal} transparent animationType="fade">
        <View style={s.modalOverlay}>
          <View style={s.modalBox}>
            <View style={s.modalHeader}>
              <Text style={[s.f700, { fontSize: 16, color: theme.brand }]}>{t("changePassword", "Change Password")}</Text>
          ...
          <View style={s.modalBox}>
            ...
            <View style={{ flexDirection: "row", gap: 10 }}>
              ...
              <TouchableOpacity onPress={doLogout} style={[s.btn, s.btnPrimary, { flex: 1 }]}>
                <Text style={[s.f600, { color: THEME.light.white }]}>{t("logout", "Logout")}</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
        ...
        <View style={s.modalOverlay}>
          <View style={s.modalScrollBox}>
            ...
            <TouchableOpacity onPress={() => setTermsModal(false)} style={[s.btn, s.btnPrimary, { marginTop: 12 }]}>
              <Text style={[s.f600, { color: THEME.light.white }]}>{t("ok", "OK")}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
